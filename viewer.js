...
( function ( marmoset ) {
    ...
    AnimatedObject.prototype.evaluateLocalTransformAtFramePercent = function ( a, c, b, d ) {
        if ( this.useFixedLocalTransform ) Matrix.copy( c, this.animatedLocalTransform.cachedmatrix0 );
            ...
            e ? Matrix.copy( c, e ) : ( ( e = this.animatedLocalTransform.getFreeCachedTransform( a ) ) ? ( this.animatedLocalTransform.evaluateMatrix( e, this.totalFrames, a, b ), e[ 12 ] -= e[ 0 ] * this.pivot.x + e[ 4 ] * this.pivot.y + e[ 8 ] * this.pivot.z, e[ 13 ] -= e[ 1 ] * this.pivot.x + e[ 5 ] * this.pivot.y + e[ 9 ] * this.pivot.z,
        ...
        for ( var e = 0; 100 > e; e++ ) {
            ...
            if ( f.useFixedWorldTransform ) {
                ...
                if ( g ) {
                    Matrix.mul( b, g, b );
                    break
                } else g = Matrix.identity(), f.evaluateLocalTransformAtFramePercent( c, g, !1, d ), g[ 12 ] += g[ 0 ] * f.pivot.x + g[ 4 ] * f.pivot.y + g[ 8 ] * f.pivot.z, g[ 13 ] += g[ 1 ] * f.pivot.x + g[ 5 ] * f.pivot.y +
    ...
    SceneAnimator.prototype.logObjectInfo = function ( a, c ) {
        ...
        if ( a >= b.animatedObjects.length ) this.debugString += "object index " + a + " exceeds " + b.animatedObjects.length;
            ...
            this.debugString += "<br>Pivot: " + e.pivot.x + " " + e.pivot.y + " " + e.pivot.z;
            this.debugString += "<br>lockTransform: " + e.animatedLocalTransform.lockTransform;
            d = Matrix.identity();
            b.getWorldTransform( e.id, c, d, this.sceneScale, !0 );
            this.debugString += e.debugString;
            this.debugString += "<br>World mat ";
            this.debugString += "<br>" + d[ 0 ] + "  " + d[ 4 ] + "  " + d[ 8 ] + "  " + d[ 12 ];
            this.debugString += "<br>" + d[ 1 ] + "  " + d[ 5 ] + "  " + d[ 9 ] + "  " + d[ 13 ];
            this.debugString += "<br>" + d[ 2 ] + "  " + d[ 6 ] + "  " + d[ 10 ] + "  " + d[ 14 ];
            this.debugString += "<br>" + d[ 3 ] + "  " + d[ 7 ] + "  " + d[ 11 ] + "  " + d[ 15 ];
            d = Matrix.identity();
            f = b.getObjectAnimationFramePercent( e, c );
            e.evaluateLocalTransformAtFramePercent( f, d, !0, !0 );
            this.debugString +=
                "<br>Local mat ";
            this.debugString += "<br>" + d[ 0 ] + "  " + d[ 4 ] + "  " + d[ 8 ] + "  " + d[ 12 ];
            this.debugString += "<br>" + d[ 1 ] + "  " + d[ 5 ] + "  " + d[ 9 ] + "  " + d[ 13 ];
            this.debugString += "<br>" + d[ 2 ] + "  " + d[ 6 ] + "  " + d[ 10 ] + "  " + d[ 14 ];
            this.debugString += "<br>" + d[ 3 ] + "  " + d[ 7 ] + "  " + d[ 11 ] + "  " + d[ 15 ];
            e.modelPartIndex != e.id && ( d = Matrix.identity(), b.getAnimatedLocalTransform( e.id, c, d ), this.debugString += "<br>Animated Local mat ", this.debugString += "<br>" + d[ 0 ] + "  " + d[ 4 ] + "  " + d[ 8 ] + "  " + d[ 12 ], this.debugString += "<br>" + d[ 1 ] + "  " + d[ 5 ] + "  " + d[ 9 ] +
                ...
                "<br>obj.modelPartScale " + e.modelPartScale );
            this.debugString += "<br>this.sceneScale " + this.sceneScale;
            var b = d[ 0 ],
                e = d[ 1 ],
                f = d[ 2 ],
                g = d[ 4 ],
